...
const RecurrentPaymentReport = (props) => {
  const entity = 'RecurrentPaymentReport';
  ...
  const Columns = [
    {
      title: "CONTROL PLANILLAS - GRUPO DANFER S.A.",
      children: [
    ...
    },
    {
      ...
      children: [
        {
          title: 'Retención Seguro Social',
          dataIndex: 'ss_salary',
          width: 100
        }, {
          title: "Retención Seguro Educativo",
          dataIndex: 'se_salary',
          width: 100
        }, {
          title: "Retención DTM",
          dataIndex: 'dtm_salary',
          width: 100
        }, {
    ...
    },
    {
      ...
      children: [
        {
          title: "SIPE Riesgos Profesionales"
        }, {
          title: "SIPE DTM"
        },
        {
          title: "SIPE Seguro Educativo"
        },
        {
          title: "SIPE Seguro Social"
        }
      ]
    }
  ...
  return (
    <DashboardLayout>
      ...
      <Layout style={{ minHeight: '100vh' }}>
        ...
        <Row>
          <Col span={10}>
            <h3 style={{ color: '#22075e', marginBottom: 5 }}>Recurrent Payment Report</h3>
          </Col>
          <Col span={7}>
